...
class RTFNet(nn.Module):
    ...
    def __init__(self, n_classes, n_channels=4):
        ...
        if self.num_resnet_layers == 50:
            resnet_raw_model1 = resnet50(weights=ResNet50_Weights.DEFAULT)
            resnet_raw_model2 = resnet50(weights=ResNet50_Weights.DEFAULT)
            self.inplanes = 2048
    ...
    def forward(self, input):
        ...
        rgb = input[:,:3,:,:]  # [1, 3, 480, 640]
        thermal = input[:,3:,:,:]  # [1, 1, 480, 640]
